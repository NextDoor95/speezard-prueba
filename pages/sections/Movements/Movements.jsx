...
function Movements() {
    ...
    const movement = [
        ...
        },
        {
            ...
            text: 'Participamos de la conocida hackathon King of Dev que se realizó en 2022, donde conocimos personas increíbles y pudimos unir grupos e ideas para avanzar en materia blockchain a nivel nacional.',
        },
        {
            id: 3,
            src: Modular,
