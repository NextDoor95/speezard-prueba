...
const wordings: Wordings = {
	...
	community: {
		...
		text: {
			p1: 'Speezard surge de la comunidad Resiliente, que cuenta con cientos de personas profundamente involucradas con la filosofía de la descentralización y blockchain, y en Speezard, están al servicio de los proyectos.',
		},
	},
	proof_of_build: {
		span: 'Proof of Build',
	...
	mentors: {
		...
		profiles: [
			...
			},
			{
				...
				description:
					'CEO @futurefundco | Building @mokatoken | UX Writer 💻 | Mentora | Embajadora @takenosapp | Community Builder @LaCryptaOficial',
				links: [
					{
						id: 'twitter',
						icon: 'twitter',
			...
			},
			{
				id: 12,
				img: 'alejandra',
				alt: 'imagen de perfil de Alejandra Cáceres',
				heading6: 'Alejandra Cáceres',
				description:
				...
				links: [
					{
						...
						icon: 'twitter',
						text: '@AleliCaceres',
						href: 'https://twitter.com/AleliCaceres',
					},
				],
			},
